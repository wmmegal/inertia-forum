<template>
    <div class="block bg-white p-6 text-gray-900 flex items-center space-x-6">
        <div class="flex-grow">
            ...
            <Link :href="`${route('discussion.show', discussion)}?post=${discussion.latest_post.id}`" class="inline-block text-sm mt-3">
